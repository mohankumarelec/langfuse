...
import { auditLog } from "@/features/audit-logs/auditLog";
import { CreatePromptTRPCSchema } from "@/features/prompts/server/utils/validation";
import { throwIfNoAccess } from "@/features/rbac/utils/checkAccess";
import {
  createTRPCRouter,
  protectedProjectProcedure,
} from "@/server/api/trpc";
import { DB } from "@/server/db";
import { type Prompt, Prisma } from "@/shared/db";

import { createPrompt } from "../actions/createPrompt";
import { orderByToPrismaSql } from "@/features/orderBy/server/orderByToPrisma";
import { promptsTableCols } from "@/server/api/definitions/promptsTable";
import { optionalPaginationZod, paginationZod } from "@/utils/zod";
import {
  orderBy,
  singleFilter,
  tableColumnsToSqlFilterAndPrefix,
} from "@/shared";
import { LATEST_PROMPT_LABEL } from "@/features/prompts/constants";
