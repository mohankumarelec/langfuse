...
import {
  ChatMlArraySchema,
  OpenAiMessageView,
} from "@/components/trace/IOPreview";
import { Tabs, TabsList, TabsTrigger } from "@/components/ui/tabs";
import { Badge } from "@/components/ui/badge";
import { Button } from "@/components/ui/button";
import { CodeView, JSONView } from "@/components/ui/CodeJsonViewer";
import { DetailPageNav } from "@/features/navigate-detail-pages/DetailPageNav";
import { DeletePromptVersion } from "@/features/prompts/components/delete-prompt-version";
import { PromptType } from "@/features/prompts/server/utils/validation";
import { useHasAccess } from "@/features/rbac/utils/checkAccess";
import useProjectIdFromURL from "@/hooks/useProjectIdFromURL";
import { api } from "@/utils/api";
import { extractVariables } from "@/utils/string";
import { type Prompt } from "@/shared";
import { ScrollArea } from "@radix-ui/react-scroll-area";
import { TagPromptDetailsPopover } from "@/features/tag/components/TagPromptDetailsPopover";
import { PromptHistoryNode } from "./prompt-history";
import { SetPromptVersionLabels } from "@/features/prompts/components/SetPromptVersionLabels";
import Generations from "@/components/table/use-cases/generations";
import {
  Accordion,
  AccordionContent,
  AccordionItem,
