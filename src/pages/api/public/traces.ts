...
import { z } from "zod";
import { cors, runMiddleware } from "@/features/public-api/server/cors";
import { prisma } from "@/shared/db";
import { verifyAuthHeaderAndReturnScope } from "@/features/public-api/server/apiAuth";
import { Prisma, type Trace } from "@/shared/db";
import { paginationZod } from "@/utils/zod";
import {
  handleBatch,
  handleBatchResultLegacy,
} from "@/pages/api/public/ingestion";
import {
  TraceBody,
  eventTypes,
  stringDate,
} from "@/features/public-api/server/ingestion-api-schema";
import { v4 } from "uuid";
import { telemetry } from "@/features/telemetry";
import { orderByToPrismaSql } from "@/features/orderBy/server/orderByToPrisma";
import { tracesTableCols, orderBy } from "@/shared";
import { isPrismaException } from "@/utils/exceptions";
