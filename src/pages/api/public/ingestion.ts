...
} from "@/features/public-api/server/apiAuth";
...
import { type ApiAccessScope } from "@/features/public-api/server/types";
import { persistEventMiddleware } from "@/server/api/services/event-service";
