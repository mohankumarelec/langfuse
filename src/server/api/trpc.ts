...
import { setUpSuperjson } from "@/utils/superjson";
...
export const protectedProjectProcedure = baseProcedure.use(
...
export const protectedGetTraceProcedure = baseProcedure.use(enforceTraceAccess);
...
export const protectedGetSessionProcedure =
  baseProcedure.use(enforceSessionAccess);
